      ...
      <div className="max-w-[1280px] mx-auto px-6 pb-0">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
          {pricingPlans.map((plan, index) => (
            <div
              key={plan.id}
              className="bg-[#1A1A1A] border-t border-gray-700"
            >
              {/* Card Content */}
              <div className={`p-8 border-r border-gray-700 ${index === 2 ? 'border-r-0' : ''}`}>
                {/* Plan Name */}
                <h3
              ...
              {/* SVG Bars and Button Container - Fixed 425px width */}
              <div className={`flex items-center justify-end border-t border-gray-700 border-r ${index === 2 ? 'border-r-0' : 'border-gray-700'}`}>
                <div className="flex items-center w-[425px] h-16">
                  {/* Left SVG Bars - 190px */}
                  <div className="w-[190px] h-16 overflow-hidden">
                    <VerticalBarsSVG />
                  </div>

                  {/* Button - Fixed 235px width */}
                  <button
                    className={`${plan.buttonColor} ${plan.buttonText} font-semibold hover:opacity-90 transition flex items-center justify-center gap-2 w-[235px] h-16`}
                    style={{ 
                      fontFamily: 'Geist Mono, monospace'
                    }}
                  >
                    <span className="text-xs uppercase tracking-wide">FREE 14 DAY TRIAL</span>
                    <svg
                      className="w-4 h-4"
                      fill="none"
                      stroke="currentColor"
        ...
        <div className="border-t border-gray-700">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
            ...
            <div className="bg-[#1A1A1A] p-8 border-r border-gray-700 flex items-center justify-center">
              <div className="max-w-md">
                <h3
                  className="text-white text-[44px] leading-[1.1] font-normal mb-4"
                  style={{ fontFamily: 'Instrument Sans Variable, sans-serif' }}
                >
                  Enterprise
                </h3>
            ...
            <div className="bg-[#1A1A1A] p-8 border-r border-gray-700 flex items-center justify-center">
              <div>
                <div
                  className="text-[#FFFCF2] text-[12px] uppercase tracking-wide mb-6"
                  style={{ fontFamily: 'Geist Mono, monospace' }}
                >
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-5 h-5 bg-white flex items-center justify-center rounded">
                      <svg
                        className="w-3 h-3 text-black"
                        fill="none"
                        stroke="currentColor"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-white text-[12px] underline hover:opacity-80"
                      style={{ fontFamily: 'Instrument Sans Variable, sans-serif' }}
                    >
                      Unlimited tasks/user*
                    </a>
                  </div>
            ...
            <div className="bg-[#1A1A1A] p-8 flex items-center justify-end">
              <a
                href="mailto:gabe@heyquin.io?subject=Enterprise%20pricing"
                className="border-2 border-white text-white font-semibold hover:bg-white hover:text-black transition flex items-center justify-center gap-2"
                style={{ 
                  width: '170px',
                  height: '66px',
                  fontFamily: 'Geist Mono, monospace'
              ...
              >
                <span className="text-sm uppercase tracking-wide">CONTACT US</span>
                <div className="w-4 h-4">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor">
                    <path d="M569.4 337L586.4 320L569.4 303L401.4 135L384.4 118L350.5 151.9L367.5 168.9L494.5 295.9L64.4 295.9L64.4 343.9L494.5 343.9L367.5 470.9L350.5 487.9L384.4 521.8L401.4 504.8L569.4 336.8z"></path>
                  </svg>
                </div>
              </a>
            </div>
